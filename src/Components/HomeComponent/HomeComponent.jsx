          ...
          >
            <div className="home-text-cont">
              <div className="home-text-1">
                Don't break the bank, let Axium code your dreams!
              </div>
              <div className="home-text-2">
                Axium is dedicated to cost efficiency, recognizing the
                difficulties businesses encounter in hiring and managing
                developers. With our solutions, clients can save up to 60% of
                their budget, enabling them to redirect resources to essential
                aspects of their operations.
              </div>
              <div className="try-now" id="home-try-now">
                Try Axium Now
